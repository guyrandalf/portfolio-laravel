...
<template>
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-dark-primary">
        <div class="container flex flex-wrap items-center justify-between mx-auto">
            <a href="#" class="flex items-center">                
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Guy Randalf</span>
            </a>
            ...
            <div class="w-full md:block md:w-auto" :class="{hidden : showMobileMenu}" id="navbar-default">
                <ul
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-white bg-light-tail-500 dark:bg-dark-navy-100 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white"
